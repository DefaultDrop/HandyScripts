...
.SYNOPSIS
A Simple script rename a domain joined PC using the format <ClientCode>-<SerialNumber>
...
.EXAMPLE
./Set-ComputerNameDomain.ps1 -ClientCode CTO -DomainUser Administrator -DomainPass P@ssw0rd
